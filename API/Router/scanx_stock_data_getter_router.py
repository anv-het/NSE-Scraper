...
# Optional commented peers
# @router.get("/charts/formatted_last_five_years_chart_peer")
# def charts_last_five_years_peer(symbol: str = Query(...)) -> Dict[str, Any]:
#     symbol = _normalize_symbol(symbol)
#     ctrl = ScanXStockDataGetterController()
#     data = ctrl.get_section(symbol, "formatted_last_five_years_chart_peer", ensure=True)
#     if data is None:
#         return create_error_response(message=f"No data for {symbol}")
#     return create_success_response_n(_wrap_data("formatted_last_five_years_chart_peer", symbol, data))

# @router.get("/charts/formatted_last_five_years_chart_peer_index")
# def charts_last_five_years_peer_index(symbol: str = Query(...)) -> Dict[str, Any]:
#     symbol = _normalize_symbol(symbol)
#     ctrl = ScanXStockDataGetterController()
#     data = ctrl.get_section(symbol, "formatted_last_five_years_chart_peer_index", ensure=True)
#     if data is None:
#         return create_error_response(message=f"No data for {symbol}")
#     return create_success_response_n(_wrap_data("formatted_last_five_years_chart_peer_index", symbol, data))
