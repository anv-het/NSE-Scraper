...
class NSEMostActiveEquitiesController:
    ...
    async def scrape_most_active_equities(self) -> Dict[str, Any]:
        ...
        try:
            ...
            # format the data 
            formatted_data = NSEDataFormatter.format_most_active_equities(data)
            
            # Save to MongoDB
            self.db.save_data(formatted_data, "nse_most_active_equities")
    ...
    #     """Scrape most active SME equities data"""
    #     try:
    ...
    #         # Save to database
    #         self._save_to_database({"data": result_data}, "most_active_sme")

    #         return create_success_response(result_data, "Most active SME equities fetched successfully")
    ...
    #     """Scrape most active ETF equities data"""
    #     try:
    ...
    #         # Save to database
    #         self._save_to_database({"data": result_data}, "most_active_etf")

    #         return create_success_response(result_data, "Most active ETF equities fetched successfully")

    #     except Exception as e:
    #         logger.error(f"Error scraping most active ETF equities: {str(e)}")
    #         return create_error_response(str(e), HTTP_STATUS.INTERNAL_SERVER_ERROR)

    # def scrape_most_active_variations(self, variation_type: str = "lower") -> Dict[str, Any]:
    #     """Scrape most active variations data"""
    #     try:
    ...
    #         # Save to database
    #         self._save_to_database({"data": data}, f"variations_{variation_type}")
    ...
    #     """Scrape most active volume gainers data"""
    #     try:
    ...
    #         # Save to database
    #         self._save_to_database({"data": data}, "volume_gainers")
