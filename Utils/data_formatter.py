            ...
            for ipo_item in data:
                try:
                    ...
                    formatted_ipo = {
                        ...
                        "offerForSaleTable": ipo_item.get("Offer For Sale (Cr)"),
                        "faceValueTable": ipo_item.get("Face Value"),
                        "ipoDiscountTable": ipo_item.get("IPO Discount"),
                        ...
                        "ipoBseCodeTable": ipo_item.get("BSE Code"),
                        "ipoNseCodeTable": ipo_item.get("NSE Code"),
